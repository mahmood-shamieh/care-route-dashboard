...
foreach ($innerData as $key => $value) {
    ...
    $data[$key] = [
        ...
        '<img class="border-2 border-primary rounded-lg" width=120 height=120 src="' .
    ...
    $data[$key]["Actions"] =
        ...
        ($_POST['section']['edit'] == 1 ?
            ...
            '<a href="index.php?cmd=users&filter=admins&suspend=1&id=' .

            $value["id"] .

            '" class="dropdown-item"><i class="icon-eye-blocked2"></i> Suspend</a>

                <a href="index.php?cmd=users&filter=admins&active=1&id=' .
    ...
    foreach ($cmsModeules as $modulesKey => $module) {
        ...
        $data[$key]["Actions"] .= '<div class="col-lg-6 col-md-12 col-sm-12">
