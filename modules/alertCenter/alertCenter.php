<?php
$cmsModeules = $db->select('select * from `cms_modules` where `administration_section` = 1');
if (isset($_POST['add'])) {
...
if (isset($_GET['suspend'])) {
    $data = array('status' => 0);
    $test = $db->update('administrators', $data, ' `id` = ' . $_GET['id']);
    print "<script language=\"JavaScript\">window.location=\"index.php?cmd=" . $_GET['cmd'] . "&done=" . $test . "\";</script>";
}
    ...
    var DatatableButtonsHtml5 = function() {
        ...
        var _componentDatatableButtonsHtml5 = function() {
            ...
            $.extend($.fn.dataTable.defaults, {
                ...
                serverSide: true,
                ajax: {
                    'url': "modules/ajaxes/alert-center/alert-center.php",
                    'type': 'POST',
                    'data': {
            ...
            //     $('#care-route-order').DataTable().ajax.reload()
            // }, 3000);
...
<div class="card">
    ...
    <table id="care-route-order" class="table datatable-button-html5-columns table-bordered dataTable">
        <thead>
            <tr>
