...
if (isset($_POST['add'])) {
    ...
    $ins_arr = array(
        ...
        'priority' => $db->sqlsafe($_POST['priority']),
        'color' => $db->sqlsafe($_POST['color']),
    ...
    $test = $db->insert('priorities', $ins_arr, false);
...
if (isset($_POST['edit']) && $_POST['edit'] != 0) {
    ...
    $db->update('priorities', $ins_prev, '`id` = ' . $_POST['edit'] );
}

if (isset($_GET['suspend'])) {
    $data = $db->select('select * from `priorities` where `id` = ' . $_GET['id']);
    foreach ($data[0] as $key => $value) {
        $data[0][$key] = $db->sqlsafe($value);
    }
    $data[0]['status'] = 0;
    $test = $db->update('priorities', $data[0], ' `id` = ' . $_GET['id']);
    print "<script language=\"JavaScript\">window.location=\"index.php?cmd=" . $_GET['cmd'] . "&done=" . $test . "\";</script>";
    die;
}
...
if (isset($_POST['delete'])) {
    $test = $db->delete('priorities', ' `id` = ' . $_POST['delete']);
    $test = $test ? 1 : 0;
    print "<script language=\"JavaScript\">window.location=\"index.php?cmd=" . $_GET['cmd'] . "&done=" . $test . "\";</script>";
    die;
}
    ...
    var DatatableButtonsHtml5 = function() {
        ...
        var _componentDatatableButtonsHtml5 = function() {
            ...
            $.extend($.fn.dataTable.defaults, {
                ...
                serverSide: true,
                ajax: {
                    'url': "modules/ajaxes/priorities/priorities-ajax.php",
                    'type': 'POST',
                    'data': {
            ...
            <div class="modal-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-sm-12 col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-left-0" placeholder="Priority Name" name="name" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 p-2">
                            <div class="row">
                                <label class="col-form-label col-lg-3 col-sm-12 col-md-3 text-left">Priority Number</label>
                                <div class="col-lg-9 col-sm-12 col-md-9">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <span class="input-group-text bg-primary border-primary text-white">
                        ...
                        <div class="col-lg-6 p-2">
                            <div class="row">
                                <label class="col-form-label col-lg-3 col-sm-12 col-md-3 text-left">Priority Description</label>
                                <div class="col-lg-9 col-sm-12 col-md-9">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <span class="input-group-text bg-primary border-primary text-white">
                                        ...
                                        <input type="text" class="form-control border-left-0" placeholder="Priority Description" name="description" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class=" col-lg-6 p-2">
                            <div class="row">
                                <label class="col-form-label col-lg-3 col-sm-12 col-md-3 text-left">Priority Color</label>
                                <div class="col-lg-9 col-sm-12 col-md-9">
                                    <div class="input-group">
                                        <span class="input-group-prepend">
                                            <span class="input-group-text bg-primary border-primary text-white">
                                        ...
                                        <input type="color" class="form-control border-left-0" placeholder="Priority Color" name="color" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
